!define PRODUCT_NAME "Craniobot"
!define PRODUCT_VERSION "1.0"
!define PY_VERSION "3.6.3"
!define PY_MAJOR_VERSION "3.6"
!define BITNESS "32"
!define ARCH_TAG ""
!define INSTALLER_NAME "Craniobot_1.0.exe"
!define PRODUCT_ICON "lab_logo1.ico"
...
!define MULTIUSER_INSTALLMODE_INSTDIR "Craniobot"
!include MultiUser.nsh

; Modern UI installer stuff 
!include "MUI2.nsh"
!define MUI_ABORTWARNING
!define MUI_ICON "lab_logo1.ico"
!define MUI_UNICON "lab_logo1.ico"
...
Section "!${PRODUCT_NAME}" sec_app
  ...
  SetOutPath "%HOMEDRIVE%\%HOMEPATH%"
    CreateShortCut "$SMPROGRAMS\Craniobot.lnk" "$INSTDIR\Python\pythonw.exe" \
      '"$INSTDIR\Craniobot.launch.pyw"' "$INSTDIR\lab_logo1.ico"
  SetOutPath "$INSTDIR"
...
Section "Uninstall"
  ...
  ; Uninstall files
    Delete "$INSTDIR\Craniobot.launch.pyw"
    Delete "$INSTDIR\lab_logo1.ico"
  ; Uninstall directories
    RMDir /r "$INSTDIR\Python"
    RMDir /r "$INSTDIR\lib"

  ; Uninstall shortcuts
      Delete "$SMPROGRAMS\Craniobot.lnk"
  RMDir $INSTDIR
